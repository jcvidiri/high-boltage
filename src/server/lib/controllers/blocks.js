...
class Block {
  constructor (index, previousHash, timestamp, data, transactionCounter, vinCounter, voutCounter, hash) {
    this.index = index
    ...
    this.voutCounter = voutCounter
    this.hash = hash.toString()
  }
}

let getGenesisBlock = () => {
  return new Block(0, 0, 1465154705, 'GENESIS BLOCK!', 0, 0, 0, '816534932c2b7154836da6afc367695e6337db8a921823784c14378abed4f7d7')
}
